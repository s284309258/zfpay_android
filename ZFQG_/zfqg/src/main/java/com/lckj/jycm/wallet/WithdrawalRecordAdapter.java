...
public class WithdrawalRecordAdapter extends RecyclerView.Adapter {
    ...
    public WithdrawalRecordAdapter(List<AccountRecordListBean.DataBean.ListBean> data) {
        mData = data;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_withdrawal_record, viewGroup, false);
