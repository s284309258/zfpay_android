package com.lckj.jycm.center.activity.map.adapter;
...
public class SearchResultAdapter extends BaseAdapter {
    ...
    public SearchResultAdapter(Context context, ArrayList<PoiItem> poiItemArrayList, ImageView currentSelectItem, int selectIndex) {
        mContext = context;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        //加载location_item布局
        View view1 = inflater.inflate(R.layout.location_activity_baidu_poi_item, null);
