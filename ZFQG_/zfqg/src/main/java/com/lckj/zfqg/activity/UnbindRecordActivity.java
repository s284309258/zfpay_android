...
public class UnbindRecordActivity extends BaseActvity {
    ...
    protected void initView() {
        customTitle.setText(getString(R.string.解绑申请记录));
        setSelector(0);
    ...
    protected void initData() {
        mFragmentList.add(new UnbindRecordFragment(0));
        mFragmentList.add(new UnbindRecordFragment(1));
        mFragmentList.add(new UnbindRecordFragment(2));
    }
