...
public class RateApplyActivity extends BaseActvity {
    ...
    LinearLayout llEpos;
    private RateApplyFragment mRateApplyFragment;
    private RateApplyFragment mRateApplyFragment1;
    private RateApplyFragment mRateApplyFragment2;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rate_apply);
    ...
    protected void initView() {
        customTitle.setText(getString(R.string.费率申请));
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK) {
            mRateApplyFragment.initData();
            mRateApplyFragment1.initData();
        }
    }

    @Override
    protected void initData() {
        mRateApplyFragment = new RateApplyFragment(0);
        mRateApplyFragment1 = new RateApplyFragment(1);
        mRateApplyFragment2 = new RateApplyFragment(2);
        mFragmentList.add(mRateApplyFragment);
        mFragmentList.add(mRateApplyFragment1);
        mFragmentList.add(mRateApplyFragment2);
    }
