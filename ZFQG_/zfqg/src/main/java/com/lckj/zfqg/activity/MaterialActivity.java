...
public class MaterialActivity extends BaseActvity {
    ...
    protected void initView() {
        customTitle.setText(getString(R.string.推广中心));
        setSelector(0);
    ...
    protected void initData() {
        mFragmentList.add(new MaterialFragment("02"));
        mFragmentList.add(new MaterialFragment("03"));
        mFragmentList.add(new MaterialFragment("04"));
    }
