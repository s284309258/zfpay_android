...
public class RateApplyRecordActivity extends BaseActvity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rate_apply_record);
    ...
    protected void initView() {
        customTitle.setText(getString(R.string.费率申请记录));
        setSelector(0);
    ...
    protected void initData() {
        mFragmentList.add(new RateApplyRecordFragment(0));
        mFragmentList.add(new RateApplyRecordFragment(1));
        mFragmentList.add(new RateApplyRecordFragment(2));
    }
    ...
    @OnClick({R.id.left_action, R.id.ll_pos, R.id.ll_mpos, R.id.ll_epos})
