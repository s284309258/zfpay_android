...
public class SimpleProgressDialog {
    ...
    public SimpleProgressDialog(Context context, String message, boolean cancelable){
        this(context, message, cancelable, 0, 0);
    }

    public SimpleProgressDialog(Context context, String message, boolean cancelable, int bgResId, @StyleRes int styleId) {

        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.view_progress_simple, null);
...
//        loadingImage.setImageResource(R.drawable.header_refresh);
        ...
        int style = styleId == 0 ? R.style.Theme_AppCompat_Dialog_No_Bg : styleId;
