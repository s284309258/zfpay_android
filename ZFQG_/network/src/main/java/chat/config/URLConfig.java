...
public class URLConfig {
    public static int conditionFlag = 0;//0开发环境，1.线上环境
    ...
    public static String getMainUrl() {
        //http://bill.s1.natapp.cc/givinggift/userInfo/front/selllvalidateCode
        String url = "192.168.191.1:8080";
//        String url = "newzf.wgzvip.com";
        if (conditionFlag == 0) {
        } else if (conditionFlag == 1) {
