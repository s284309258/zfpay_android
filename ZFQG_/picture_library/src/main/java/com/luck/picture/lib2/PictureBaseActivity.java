...
import com.luck.picture.lib2.dialog.PictureDialog;
import com.luck.picture.lib2.entity.EventEntity;
...
public class PictureBaseActivity extends FragmentActivity {
     ...
     * @param point
     */
    protected void rotateImage(int degree, File file, Point point) {
        if (degree > 0) {
            // 针对相片有旋转问题的处理方式
            try {
                ...
                Bitmap bmp = PictureFileUtils.rotaingImageView(degree, bitmap,point);
