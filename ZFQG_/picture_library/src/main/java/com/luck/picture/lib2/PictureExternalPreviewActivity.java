...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    public class SimpleFragmentAdapter extends PagerAdapter {
        ...
        private HashMap<String,Boolean> loadedMap = new HashMap<>();
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (media != null) {
                ...
                if (path!=null&&!path.contains("/"))path = container.getContext().getSharedPreferences("lcwl", Context.MODE_PRIVATE).getString("pref_qiniu_domain", "")+"/"+path;
                boolean isHttp = PictureMimeType.isHttp(path);
                // 可以长按保存并且是网络图片显示一个对话框
                if (isHttp&&(loadedMap.get(path)==null||!loadedMap.get(path))) {
                    showPleaseDialog();
                }
                ...
                if (isGif && !media.isCompressed()) {
                    ...
                    Glide.with(PictureExternalPreviewActivity.this).asGif()
                            .load(path).apply(new RequestOptions().override(ScreenUtils.getScreenWidth(PictureExternalPreviewActivity.this), ScreenUtils.getScreenHeight(PictureExternalPreviewActivity.this))
                    ...
                    Glide.with(PictureExternalPreviewActivity.this).asBitmap()
                            .load(path).apply(new RequestOptions().diskCacheStrategy(DiskCacheStrategy.ALL))

                            .into(new SimpleTarget<Bitmap>(ScreenUtils.getScreenWidth(PictureExternalPreviewActivity.this), ScreenUtils.getScreenHeight(PictureExternalPreviewActivity.this)) {
                                @Override
                ...
                if (getOnLongClickListner()!=null){
                    imageView.setTag(R.id.image_view_tag_path,path);
                    imageView.setOnLongClickListener(getOnLongClickListner());
                }else {
            ...
            switch (msg.what) {
                ...
                case 1:
                    ...
                    if (parent instanceof RelativeLayout){
                        int paddingTop = ((RelativeLayout) parent).getPaddingTop();
                        if (paddingTop>0){
