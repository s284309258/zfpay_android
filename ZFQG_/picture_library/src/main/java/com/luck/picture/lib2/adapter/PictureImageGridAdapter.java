...
import com.luck.picture.lib2.anim.OptAnimationLoader;
...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void changeCheckboxState(ViewHolder contentHolder, LocalMedia image) {
        ...
        if (selectImages.size() >= (pictureType.startsWith(PictureConfig.IMAGE)?maxSelectNum:1) && !isChecked) {
            boolean eqImg = pictureType.startsWith(PictureConfig.IMAGE);
            String str = eqImg ? context.getString(R.string.picture_message_max_num, maxSelectNum+"")
                    : context.getString(R.string.picture_message_video_max_num, /*maxSelectNum+*/"1");
