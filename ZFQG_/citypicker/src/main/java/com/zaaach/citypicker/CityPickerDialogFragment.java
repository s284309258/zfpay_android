...
public class CityPickerDialogFragment extends DialogFragment implements TextWatcher,
    ...
    private void initData() {
        ...
        if (mHotCities == null || mHotCities.isEmpty()) {
            ...
            mHotCities.add(new HotCity("北京", "北京", "101010100", "116.405285", "39.904989"));
            mHotCities.add(new HotCity("上海", "上海", "101020100", "121.472644", "31.231706"));
            mHotCities.add(new HotCity("广州", "广东", "101280101", "113.280637", "23.125178"));
            mHotCities.add(new HotCity("深圳", "广东", "101280601", "114.085947", "22.547"));
            mHotCities.add(new HotCity("天津", "天津", "101030100", "117.190182", "39.125596"));
            mHotCities.add(new HotCity("杭州", "浙江", "101210101", "120.153576", "30.287459"));
            mHotCities.add(new HotCity("南京", "江苏", "101190101", "118.767413", "32.041544"));
            mHotCities.add(new HotCity("成都", "四川", "101270101", "104.065735", "30.659462"));
            mHotCities.add(new HotCity("武汉", "湖北", "101200101", "114.298572", "30.584355"));
        }
        //初始化定位城市，默认为空时会自动回调定位
        if (mLocatedCity == null){
            mLocatedCity = new LocatedCity(getString(R.string.cp_locating), "未知", "0", "0", "0");
        ...
        mAllCities.add(1, new HotCity("热门城市", "未知", "0", "0", "0"));
        mResults = mAllCities;
    }
